                ...
                <div className="bg-white shadow rounded-md md: w-3/4 mx-auto px-5 py-10 mt-5 content-center">
                    ...
                    <table className="table-fixed">
                        ...
                        {opcionesItems.map(item =>(
                            <tr  key={item.nombre}>
                                <td className="border px-8 py-4">{item.lote} {item.nombre} ({item.cantlote} x {item.unidad})</td>
                                <td className="border px-8 py-4">{item.cantidad} ({item.peso} {item.unidad} c/u)</td>
                                <ItemBodega
                                    id_item={item.id}
                                    id_bodega={bodega_id}
