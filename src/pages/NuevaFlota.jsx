...
import FormularioFlota from "../components/FormularioFlota";
import Error from "../components/Error";
import {obtenerUbicaciones} from "../data/ubicaciones";
import { agregarFlota } from "../data/flotas"
...
export  async function action({request}){
    ...
    // const nombre = formData.get('nombre_flota')
...
function NuevaFlota() {
    ...
    const {ubicaciones, transporte} = useLoaderData()
