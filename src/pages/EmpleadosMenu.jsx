                ...
                <div className="grid grid-cols-2 gap-10">
                    <div className="flex flex-col items-center">
                        ...
                        <button className="flex justify-center mt-3 ml-5 rounded bg-orange-300 p-2 uppercase font-bold text-black text-sm">
                            <Link state={location.state} to='/empleados'>Empleados</Link>
                        </button>
                    </div>
                    <div className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <button className="flex justify-center mt-3 ml-5 rounded bg-orange-300 p-2 uppercase font-bold text-black text-sm">
                            <Link state={location.state} to='/empleados/departamentos'>Departamentos</Link>
                        </button>
                    </div>
                    <div className="flex flex-col items-center">
                        ...
                        <button className="flex justify-center mt-3 ml-5 rounded bg-orange-300 p-2 uppercase font-bold text-black text-sm">
                            <Link state={location.state} to='/empleados/cargos'>Cargos</Link>
                        </button>
                    </div>
                </div>
            </div>
